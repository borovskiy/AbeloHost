...
def test_get_report(client):
    with patch("app.services.report_service.ReportServices.get_all_report_by_filter") as mock_method:
...
def test_get_country_stats_success(client):
    ...
    with patch("app.services.report_service.ReportServices.get_report_country") as mock_method:
        mock_method.return_value = AsyncMock()
        mock_method.return_value = [
            {
                "country": "Russia",
